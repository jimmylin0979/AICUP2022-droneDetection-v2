pwd = "."
_base_ = [f'../../mmdetection/configs/_base_/schedules/schedule_1x.py', f'{pwd}/mmdetection/configs/_base_/default_runtime.py']
...
model = dict(
    ...
    test_cfg=dict(score_thr=0.01, nms=dict(type='soft_nms', iou_threshold=0.5, method='gaussian')))
...
max_epochs = 300
num_last_epochs = 15
load_from = f'{pwd}/mmdetection/weights/yolox_s_8x8_300e_coco_20211121_095711-4592a793.pth'
resume_from = None
interval = 10
...
checkpoint_config = dict(interval=interval, max_keep_ckpts=3)
evaluation = dict(
    save_best='auto',
...
# Inference
work_dir = f'{pwd}/results/yolox'
checkpoint = f"{work_dir}/best_bbox_mAP_epoch_14.pth"