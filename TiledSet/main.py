...
if __name__ == "__main__":
    ...
    root_originalImage = "../data/Public Testing Dataset_v2/public"
    tileSet.merge(prediction_path="../runs/yolov7/detect/yolov7-e6e_drone_aug12_tile/predictions_tiled.csv", root_originalImage=root_originalImage, sep=",")
